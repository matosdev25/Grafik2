...
const Portafolio = () => {
  ...
  return (
    <section className="font-gilroy py-20 px-4" id="portafolio">
          ...
          {portfolioItems.map((item) => (
            ...
            >
              <div className="w-full h-full bg-gradient-to-br from-teal-500/20 to-teal-600/10 flex items-center justify-center group-hover:from-teal-500/30 group-hover:to-teal-600/20 transition-all duration-300">
                {/* Título dentro de la card en Queering */}
                <span className="font-queering text-white/40 text-sm font-medium">
                  Proyecto {item.id}
                </span>
              </div>
            </div>
